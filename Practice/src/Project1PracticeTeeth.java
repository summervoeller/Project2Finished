...
public class Project1PracticeTeeth {
    ...
    public static void main(String[] args) {
        ...
        String[] names = new String[MAX_FAMILY_MEMBERS];
        char[][][] teethRecords = new char[MAX_FAMILY_MEMBERS][2][MAX_TEETH];
        ...
        inputFamilyData(names, teethRecords, numFamilyMembers);
        processMenuOptions(names, teethRecords, numFamilyMembers);
    ...
    private static void inputFamilyData(String[] names, char[][][] teethRecords, int numFamilyMembers) {
        // Start of for loop
